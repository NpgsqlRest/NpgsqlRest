...
This release focuses on two things: making real-time push (SSE) more honest about what your annotations mean, and getting more throughput out of array- and composite-heavy responses without changing any public API. Everything in 3.14.0 is non-breaking — existing apps upgrade in place.
