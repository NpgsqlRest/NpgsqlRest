...
public static partial class ConfigSchemaGenerator
{
    ...
    internal const string DefaultConfigJsonc = """
    {
      ...
      "TestRunner": {
        ...
        "Keep": false,
        //
        // Show captured `raise notice` output for all tests, not just failed/errored ones.
        //
        "Verbose": false,
        //
        ...
        //
        // Run-once setup, BEFORE endpoint discovery. Command steps run first (provision infra, e.g. docker),
        // then SqlFile/Sql steps (migrations/seed) — declared order preserved within each group. Each entry:
        //   { "Command": "...", "WorkingDirectory": "..." } | { "SqlFile": "..." } | { "Sql": "..." }
        //
        "Setup": [],
        //
        // Run-once teardown, ALWAYS (best-effort), reverse order: SqlFile/Sql first, then Command. `Keep` skips it.
        //
        "Teardown": []
      },
