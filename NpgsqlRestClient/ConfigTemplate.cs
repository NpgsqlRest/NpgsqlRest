...
public static partial class ConfigSchemaGenerator
{
    ...
    internal const string DefaultConfigJsonc = """
    {
      ...
      "TestRunner": {
        ...
        // tree (e.g. an included fixture) re-runs everything. Endpoint sources are not watched — restart to
        // rebuild endpoints. Teardown runs once, on exit; a graceful stop exits 0 (not for CI gating).
        //
        "Watch": false,
        //
