...
public static class ConfigDefaults
{
    ...
    private static JsonObject GetNpgsqlRestDefaults()
    {
        return new JsonObject
        {
            ...
            ["DartClientCodeGen"] = GetDartClientCodeGenDefaults(),
    ...
    private static JsonObject GetDartClientCodeGenDefaults()
    {
        return new JsonObject
        {
            ["Enabled"] = false,
    ...
    private static bool IsOpenDictionarySection(string path)
    {
        ...
        if (path is
            ...
            "NpgsqlRest:ClientCodeGen:CustomHeaders" or
            "NpgsqlRest:DartClientCodeGen:CustomHeaders")
        {
            return true;
        }
