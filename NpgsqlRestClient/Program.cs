...
NpgsqlRestOptions options = new()
{
    ...
    CommentsMode = config.GetConfigEnum<CommentsMode?>("CommentsMode", config.NpgsqlRestCfg) ?? CommentsMode.OnlyAnnotated,
    ...
    JsonTimestampsAreUtc = config.GetConfigBool("JsonTimestampsAreUtc", config.NpgsqlRestCfg, true),
    ...
    SubstitutionEnvironmentVariables = builder.GetSubstitutionEnvVars(),
